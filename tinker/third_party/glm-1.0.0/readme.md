...
For more information about *GLM*, please have a look at the [manual](Projects/On%20hold/Voxel%20Engine%20(not%20works%20because%20was%20edited%20and%20not%20finalized)/Code/third_party/glm-1.0.0/manual.md) and the [API reference documentation](http://glm.g-truc.net/0.9.9/api/modules.html).
The source code and the documentation are licensed under either the [Happy Bunny License (Modified MIT) or the MIT License](Projects/On%20hold/Voxel%20Engine%20(not%20works%20because%20was%20edited%20and%20not%20finalized)/Code/third_party/glm-1.0.0/manual.md#section0).
...
- Added [`GLM_ENABLE_EXPERIMENTAL`](Projects/On%20hold/Voxel%20Engine%20(not%20works%20because%20was%20edited%20and%20not%20finalized)/Code/third_party/glm-1.0.0/manual.md#section7_4) to enable experimental features.
